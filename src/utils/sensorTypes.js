...
export const SENSOR_TYPES = {
  temperatura: { label: 'Temperatura', unidad: '°C', color: '#ef4444', tint: '#fee2e2', icon: '🌡️', min: 12, max: 32 },
  humedad: { label: 'Humedad del suelo', unidad: '%', color: '#3b82f6', tint: '#dbeafe', icon: '💧', min: 20, max: 90 },
  luz: { label: 'Luz', unidad: 'lux', color: '#f59e0b', tint: '#fef3c7', icon: '☀️', min: 200, max: 1000 },
}
